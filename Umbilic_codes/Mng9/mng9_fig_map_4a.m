...
%plot(-cdout1(1:ntheta,1),cdout1(1:ntheta,2)/2,'g','LineStyle','none','Marker','.','MarkerSize',5 )
...
print(fh,  '-depsc', './Figures_umb/mng9_fig_map4a.eps')
